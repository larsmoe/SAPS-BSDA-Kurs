...
library(RTutor)
check.problem.set('PS_3', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
```{r "6",fig.height=14, fig.width=14}
...
```{r "6__8",fig.height=14, fig.width=14}
