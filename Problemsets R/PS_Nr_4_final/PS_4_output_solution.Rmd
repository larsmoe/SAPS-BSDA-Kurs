...
head(x=membership(communities=karate_cl_edgebtw))
...
- - -
```{r "8__10",fig.height=10, fig.width=12}
...
- - -
```{r "8__11",fig.height=10, fig.width=12}
...
Quiz: Je größer beta wird, desto

- flacher wird die Kurve [ ]

- steiler steigt und fällt die Kurve und desto höher liegt das Maximum [x]
